...
model_path = 'E:/RT-GENE/mtcnn_twoeyes_inpainted_eccv/'
...
# model_prefixes = ['']
# model_suffixes = ['eccv_'+model_type+'_'+str(fc1_size)+'_'+str(fc2_size)+'_'+str(fc3_size)+'_'+str(batch_size)+'_4_'+epoch]
