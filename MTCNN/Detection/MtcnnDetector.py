...
class MtcnnDetector(object):
    ...
    def pad(self, bboxes, w, h):
        ...
        # edx[tmp_index] = tmpw[tmp_index] - ( ex[tmp_index] - (w-1) ) - 1   edx indicate the end point in the box image
    ...
    def detect_pnet(self, im):
        ...
        h, w, c = im.shape
        net_size = 12
        #resize the image according to the face proportion se/face_siz
    ...
    def detect_rnet(self, im, dets):
        ...
        for i in range(num_boxes):
            ...
            #choose the cadidate box and resize
    ...
    def detect_face(self, test_data):
        ...
        for databatch in test_data:
            ...
            #question 5  ?????? no landmark location
            landmark = [1]
