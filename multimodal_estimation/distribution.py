...
def get_data(files, label):
    ...
    return images_l,images_r,gazes_l,gazes_r,headposes_l,headposes_r,orginheadpose,num_instances
...
train_images_l, train_images_r, train_gazes_l, train_gazes_r, \
train_headposes_l, train_headposes_r, test_orginheadpose,train_num = get_data(files, 'eval_data')
toh=pose2dir(test_orginheadpose)
for i in range(30):
    k=i
    print(i)
    print(toh[i])
    show_img(train_images_l[k],train_images_r[k])
# dir=pose2dir(test_orginheadpose)
# hist(dir)
